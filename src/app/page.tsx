...
export default function Home() {
	return (
		<div className="bg-slate-50">
			<section>
				<MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pr-32 lg:pb-52">
			...
			<section className="bg-slate-1000 py-24">
				<MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
					<div className="flex flex-col lg:flex-row items-center sm:gap-6 gap-4">
					...
					<div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:px-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
							...
							<div className="flex gap-4 mt-2">
								...
								<div className="flex flex-col">
									...
									<div className="flex gap-1.5 items-center text-zinc-600">
										<Check className="h-4 w-4 strok-[3px] text-green-600" />
						...
						{/* <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
							...
							<div className="text-lg leading-8">
								<p>&quot;The new case clearly is durable and I love it because it has a picture of my dog which was kind of a memory to me &quot;</p>
							</div>
							<div className="flex gap-4 mt-2">
			...
			<section>
				<MaxWidthWrapper className="py-24">
					...
					<ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y2 w-fit">
						<li className="w-fit">
						...
						<li className="w-fit">
							<Check className="h-5 w-5 text-green-600 inline mr-1.5" />
							Scratch and finger print resistance coating
						</li>
						<li className="w-fit">
							<Check className="h-5 w-5 text-green-600 inline mr-1.5" />
